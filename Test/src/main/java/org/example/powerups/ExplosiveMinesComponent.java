...
public class ExplosiveMinesComponent extends Component {
    ...
    private class MineBehaviorComponent extends Component {
        ...
        private void explode() {
            ...
            SoundManager.getInstance().playSound("explosion"); // Play explosion sound
            ...
            // Get current damage value for explosion
            double currentDamage = explosionDamage;
            
            // Debug info
            if (playerComponent != null) {
                int currentLevel = playerComponent.getWeaponLevel("explosive_mines");
                System.out.println("Mine explosion - Level: " + currentLevel + 
                                  ", Dealing damage: " + currentDamage);
            }
    ...
    public static String getLevelDescription(int level, boolean nextLevel) {
        ...
        switch (level) {
            ...
            default: return level > 6 ? "MAXED OUT" : "Creates explosion mines that damage enemies";
        }
    }
}